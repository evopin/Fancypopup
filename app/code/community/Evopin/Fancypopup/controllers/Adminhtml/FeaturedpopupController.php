...
class Shopgo_Featuredpopup_Adminhtml_FeaturedpopupController extends Mage_Adminhtml_Controller_action
{
	...
	protected function _initAction() {
		...
		$this->loadLayout()
			->_setActiveMenu('cms/featuredpopup')
	...
	public function saveAction() {
		...
		if(isset($_FILES['image_link']['name']) and (file_exists($_FILES['image_link']['tmp_name']))) {
  			try {
    			...
    			$path = Mage::getBaseDir('media') . DS .'shopgo/featuredpopup';
    			$uploader->save($path, $_FILES['image_link']['name']);
    			$name_image_link = $uploader->getUploadedFileName();
    			$data['image_link'] = 'shopgo/featuredpopup/' . $name_image_link;
