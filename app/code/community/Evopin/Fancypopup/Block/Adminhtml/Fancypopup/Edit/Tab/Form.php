...
class Shopgo_Featuredpopup_Block_Adminhtml_Featuredpopup_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      ...
      $fieldset->addField('is_active', 'select', array(
          ...
          'options' => $this->helper('featuredpopup/data')->getStatusOptions(),
          'class'     => 'required-entry',
          'required'  => true,
          'name'      => 'is_active',
	  ));  
